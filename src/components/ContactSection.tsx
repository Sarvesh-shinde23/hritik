        ...
        <div className="flex flex-wrap justify-center items-start w-full">
          <div className="flex flex-col justify-center pt-6 min-h-[561px] max-w-full">
            <div className="flex flex-col px-8 pt-8 pb-24 w-full bg-white shadow-lg">
              {[
                {
                  iconSrc: "https://cdn.builder.io/api/v1/image/assets/TEMP/ada8c7460c666258359d88ca2d8f0400b57d50f516b2971064b19f3f8a9f18b8?placeholderIfAbsent=true&apiKey=bc78d96b1bfe4229ab8bdab79a935f37",
                  title: "Address",
                  description: "123 Business Rd, City, Country"
                },
                {
                  iconSrc: "https://cdn.builder.io/api/v1/image/assets/TEMP/324d25fe9ce5a7b14fe10935406376276a2c4867a1492e4003569cfa3d156f7e?placeholderIfAbsent=true&apiKey=bc78d96b1bfe4229ab8bdab79a935f37",
                  title: "Call Us",
                  description: "+123 456 7890"
                },
                {
                  iconSrc: "https://cdn.builder.io/api/v1/image/assets/TEMP/ff75e0b8837a2bbdf11c3c74157f3da17c5a8f86c4071149871051ed47557463?placeholderIfAbsent=true&apiKey=bc78d96b1bfe4229ab8bdab79a935f37",
                  title: "Email Us",
